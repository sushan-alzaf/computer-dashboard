      ...
      <div className="mt-5">
        {rows.map((_, index) => (
          <div key={index} className="flex justify-between mb-[30px]">
            ...
            <button
              ...
              className="text-[#667085] bg-[#F2F4F7] px-5 py-[10px] rounded-[8px] text-sm font-normal leading-5 (--font-family-Inter) flex items-center gap-[8px]"
            >
              <DeleteIcon /> Delete{" "}
            </button>
          </div>
        ...
        <div className="flex justify-between items-center">
          <button
            ...
            className="text-[#F97316] text-sm font-medium leading-5 (--font-family-Inter) border border-[#F97316] px-[14px] py-[10px] w-[120px] h-[40px] flex items-center justify-center gap-[8px] rounded-[8px]"
          >
            {" "}
            <span>
              <PlusIcon />
          ...
          <button className="w-[136px] h-[40px] bg-[#F97316] flex items-center px-5 py-[10px] text-sm font-meduim leading-5 text-white rounded-[8px]">
            Add to Variant
          </button>
        </div>
      </div>
      <div className={`mt-[30px] ${openTable ? "" : "d-none hidden"}`}>
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5   items-center gap-[11px]">
          <div className="border flex rounded-[8px]  ">
            <label
              className="text-sm text-[#475467] flex items-center justify-center bg-[#F2F4F7] px-[10px] w-[75px] h-[40px] font-medium leading-5 border-r-[1px]"
              htmlFor=""
            >
              BDT
            </label>
            <input
              className=" outline-none border-none px-4 text-[#98A2B3] text-sm font-normal "
              placeholder="256"
              type="text"
            />
          </div>
          <div className="border flex rounded-[8px] ">
            <label
              className="text-sm text-[#475467] px-[10px] flex items-center justify-center bg-[#F2F4F7] w-[75px] h-[40px] py-[15px] font-medium leading-5 border-r-[1px]"
              htmlFor=""
            >
              BDT
            </label>
          ...
          <button className="w-[234px] h-[40px]  justify-center bg-[#F97316] flex items-center px-5 py-[10px] text-sm font-meduim leading-5 text-white rounded-[8px]">
            Apply for All
          </button>
        </div>
        <div>
